...
SAi0
SAz0
SAf0bash %<CY> -c "gnatmake %<D> -g %<D> %<FLAGS> -D %<DEF_BIN_DIR> -o %<RELE_DEF_BIN_DIR>%<proj_base>%<EXE_EXT> %<REL_MAIN_FILE> %<FLAGS2>"
SAj0%<DEF_SRC_DIR>
SAA0GNU
...
SAi0
SAz0
SAf0gnatmake %<CY> %<D> -g %<D> %<FLAGS> -D %<REL_DEF_BIN_DIR> -o %<RELE_DEF_BIN_DIR>%<proj_base>%<EXE_EXT> %<REL_MAIN_FILE> %<FLAGS2>
SAj0%<DEF_SRC_DIR>
SAA0GNU
SAg0gcc %<CY> -c -D %<REL_DEF_BIN_DIR> -o %<RELE_DEF_BIN_DIR>%<base>.o %D -g %D %FLAGS %file
SAk0%<DEF_SRC_DIR>
