...
public class WebcatSubmitDialog {
   ...
   private ListCellRenderer<Object> listRenderer =
   ...
   private JPanel buildPage2() {
      ...
      fileList = new TTList<File>(fileListModel, "Files to be Submitted");
         ...
         new KeyAdapter() {
            public void keyPressed(final KeyEvent e) {
               ...
               if (code == KeyEvent.VK_DELETE) {
                  removeFiles(fileList.getSelectedValuesList());
               }
            }
         }
         );
      ...
      removeButton.addActionListener(
            (e)->removeFiles(fileList.getSelectedValuesList()));
      removeButton.setEnabled(false);
      buttonPanel.add(removeButton);
      
      fileList.addListSelectionListener(
            (e)->removeButton.setEnabled(!fileList.isSelectionEmpty()));
    ...
    *
    *  @param fileToRemove the files to be removed. **/
   private void removeFiles(final List<File> filesToRemove) {
   ...
   private String createSubmitter(final String url) {
      ...
      try {
         ...
         return "Bad assignment definition URL \""
                  + url + "\": " + ToolUtil.getDetailMessage(e);
      }
      catch (IOException e) {
         return "Error reading submission targets from URL \""
               + url + "\": " + ToolUtil.getDetailMessage(e);
      }
      ...
      Runnable runnable = 
         ()-> {
            try {
               ...
               final String msg = ToolUtil.getDetailMessage(e);
               SwingUtilities.invokeLater(
            ...
            SwingUtilities.invokeLater(()->processResponse());
         };
   ...
   private void processResponse() {
      ...
      try {
         ...
         showError("Error displaying results: " + ToolUtil.getDetailMessage(e)
               + "\n\nYou should login to WebCAT directly to view"
               + "your results.");
      }
      catch (IOException e) {
