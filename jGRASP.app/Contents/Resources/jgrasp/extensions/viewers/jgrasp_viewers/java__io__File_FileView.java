...
public class java__io__File_FileView extends TextAreaView {
   ...
   public String getDisplayText(final Value value, final DebugContext context)
      ...
      Method isDirMethod =
            value.getMethod(context, "isDirectory", "boolean", null);
      ...
      Method lastModMethod =
            value.getMethod(context, "lastModified", "long", null);
