...
public class java__lang__Throwable_ThrowableView extends TextAreaView {
   ...
   public String getDisplayText(final Value value, final DebugContext context)
      ...
      Constructor pwConstructor =
            pwType.getConstructor(context, new String[]
            { "java.io.Writer" });
      Value pw =
            pwType.createInstance(context, pwConstructor, new Value[]
            { sw });

      Method pstMethod =
            value.getMethod(context, "printStackTrace", "void", new String[]
            { "java.io.PrintWriter" });
      value.invokeMethod(context, pstMethod, new Value[] { pw });

      Method gbMethod =
            sw.getMethod(context, "getBuffer", "java.lang.StringBuffer", null);
