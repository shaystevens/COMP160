...
public class java__lang__Float_FloatView extends FloatView {
    ...
    *
    * @param value the value of interest, of type java.lang.Float.
    *
    ...
    * value. **/
   private float getValue(final Value value, final DebugContext context)
         throws ViewerException {
      Method getValueMethod =
            value.getMethod(context, "floatValue", "float", null);
